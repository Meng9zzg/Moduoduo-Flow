...
class MarkdownTextSplitter_TextSplitters implements INode {
    ...
    constructor() {
        ...
        this.labelKey = 'nodes.textsplitters.markdownTextSplitter.label'
        this.descriptionKey = 'nodes.textsplitters.markdownTextSplitter.description'
        this.categoryKey = 'nodes.textsplitters.markdownTextSplitter.category'
