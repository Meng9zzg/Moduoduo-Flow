...
class RecursiveCharacterTextSplitter_TextSplitters implements INode {
    ...
    constructor() {
        ...
        this.labelKey = 'nodes.textsplitters.recursiveCharacterTextSplitter.label'
        this.descriptionKey = 'nodes.textsplitters.recursiveCharacterTextSplitter.description'
        this.categoryKey = 'nodes.textsplitters.recursiveCharacterTextSplitter.category'
