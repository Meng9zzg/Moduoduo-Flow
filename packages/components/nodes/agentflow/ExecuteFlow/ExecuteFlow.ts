...
class ExecuteFlow_Agentflow implements INode {
    ...
    constructor() {
        ...
        this.labelKey = 'nodes.executeFlowAgentflow.label'
        this.descriptionKey = 'nodes.executeFlowAgentflow.description'
        this.categoryKey = 'nodes.executeFlowAgentflow.category'
