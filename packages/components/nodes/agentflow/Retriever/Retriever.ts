...
class Retriever_Agentflow implements INode {
    ...
    constructor() {
        ...
        this.labelKey = 'nodes.retrieverAgentflow.label'
        this.descriptionKey = 'nodes.retrieverAgentflow.description'
        this.categoryKey = 'nodes.retrieverAgentflow.category'
