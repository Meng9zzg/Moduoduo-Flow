...
class OpenAPIToolkit_Tools implements INode {
    ...
    constructor() {
        ...
        this.labelKey = 'nodes.tools.openAPIToolkit.label'
        this.descriptionKey = 'nodes.tools.openAPIToolkit.description'
        this.categoryKey = 'nodes.tools.openAPIToolkit.category'
