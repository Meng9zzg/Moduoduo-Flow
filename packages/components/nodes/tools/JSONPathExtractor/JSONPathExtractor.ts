...
class JSONPathExtractor_Tools implements INode {
    ...
    constructor() {
        ...
        this.labelKey = 'nodes.tools.jsonPathExtractor.label'
        this.descriptionKey = 'nodes.tools.jsonPathExtractor.description'
        this.categoryKey = 'nodes.tools.jsonPathExtractor.category'
