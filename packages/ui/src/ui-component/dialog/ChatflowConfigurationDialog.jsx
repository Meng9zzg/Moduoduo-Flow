...
const CHATFLOW_CONFIGURATION_TABS = (t) => [
    {
    ...
    {
        label: t('chatflowConfig.tabs.textToSpeech'),
        id: 'textToSpeech'
    },
    {
...
const ChatflowConfigurationDialog = ({ show, isAgentCanvas, dialogProps, onCancel }) => {
    ...
    const filteredTabs = CHATFLOW_CONFIGURATION_TABS(t).filter((tab) => !isAgentCanvas || !tab.hideInAgentFlow)
