            ...
            <DialogTitle sx={{ fontSize: '1rem' }} id='alert-dialog-title'>
                <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <OutlinedInput
                        ...
                        variant='outlined'
                        placeholder={t('viewLeads.searchPlaceholder')}
                ...
                {leads && leads.length > 0 && (
                    <TableContainer component={Paper}>
                        <Table sx={{ minWidth: 650 }} aria-label='simple table'>
                            <TableHead>
                                <TableRow>
                                    <TableCell>{t('viewLeads.name')}</TableCell>
                                    <TableCell>{t('viewLeads.emailAddress')}</TableCell>
                                    <TableCell>{t('viewLeads.phone')}</TableCell>
                                    <TableCell>{t('viewLeads.createdDate')}</TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
