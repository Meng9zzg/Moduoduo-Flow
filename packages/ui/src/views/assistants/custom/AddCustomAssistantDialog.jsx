...
const AddCustomAssistantDialog = ({ show, dialogProps, onCancel, onConfirm }) => {
    ...
    const createCustomAssistant = async () => {
        try {
            ...
            if (createResp.data) {
                enqueueSnackbar({
                    message: t('customAssistant.messages.createSuccess'),
                    options: {
            ...
            enqueueSnackbar({
                message: t('customAssistant.messages.createError', {
    ...
    const component = show ? (
        ...
        >
            ...
            <DialogActions>
                <Button onClick={() => onCancel()}>{t('customAssistant.cancelButton')}</Button>
