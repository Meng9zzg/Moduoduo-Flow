            ...
            <DialogContent>
                <Box sx={{ p: 2 }}>
                    <Stack sx={{ position: 'relative' }} direction='row'>
                        <Typography variant='overline'>
                            {t('loadAssistant.credentialLabel')}
                    ...
                    <CredentialInputHandler
                        ...
                        inputParam={{
                            label: t('loadAssistant.connectCredential'),
                            name: 'credential',
                            type: 'credential',
                ...
                {credentialId && (
                    <Box sx={{ p: 2 }}>
                        <Stack sx={{ position: 'relative' }} direction='row'>
                            <Typography variant='overline'>
                                {t('loadAssistant.assistantsLabel')}
                                <span style={{ color: 'red' }}>&nbsp;*</span>
                            </Typography>
                        </Stack>
                        <Dropdown
                            ...
                            value={selectedOpenAIAssistantId ?? t('loadAssistant.chooseOption')}
                        />
                    </Box>
                )}
            </DialogContent>
