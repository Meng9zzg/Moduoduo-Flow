...
const Marketplace = () => {
    ...
    useNotifier()
    const { t } = useTranslation(['marketplaces', 'common'])
                                ...
                                <>
                                    ...
                                    >
                                        ...
                                        <Select
                                            ...
                                            input={<OutlinedInput label={t('marketplaces:tag')} />}
                                    ...
                                    >
                                        ...
                                        <Select
                                            ...
                                            input={<OutlinedInput label={t('marketplaces:type')} />}
                                            renderValue={(selected) => selected.join(', ')}
                                            MenuProps={MenuProps}
                                            sx={getSelectStyles(theme.palette.grey[900] + 25, theme?.customization?.isDarkMode)}
                                        >
                                    ...
                                    >
                                        ...
                                        <Select
                                            ...
                                            input={<OutlinedInput label={t('marketplaces:framework')} />}
                                            renderValue={(selected) => selected.join(', ')}
                                            MenuProps={MenuProps}
                                            sx={getSelectStyles(theme.palette.grey[900] + 25, theme?.customization?.isDarkMode)}
                                        >
                            ...
                            <Stack direction='row' justifyContent='space-between' sx={{ mb: 2 }}>
                                <Tabs value={activeTabValue} onChange={handleTabChange} textColor='primary' aria-label='tabs'>
                                    <PermissionTab
                                        ...
                                        value={0}
                                        label={t('marketplaces:communityTemplates')}
                                    />
                                    <PermissionTab permissionId='templates:custom' value={1} label={t('marketplaces:myTemplates')} />
                                </Tabs>
                                <Autocomplete
                                    id='useCases'
                                    multiple
                                ...
                                {!isLoading &&
                                    (!getAllTemplatesMarketplacesApi.data || getAllTemplatesMarketplacesApi.data.length === 0) && (
                                        <Stack sx={{ alignItems: 'center', justifyContent: 'center' }} flexDirection='column'>
                                            ...
                                            <div>{t('marketplaces:noMarketplaceYet')}</div>
                                        </Stack>
                                    )}
                            </TabPanel>
                        </Available>
                            ...
                            <TabPanel value={activeTabValue} index={1}>
                                ...
                                {!isLoading && (!getAllCustomTemplatesApi.data || getAllCustomTemplatesApi.data.length === 0) && (
                                    <Stack sx={{ alignItems: 'center', justifyContent: 'center' }} flexDirection='column'>
                                        ...
                                        <div>{t('marketplaces:noSavedCustomTemplates')}</div>
                                    </Stack>
                                )}
                            </TabPanel>
                        </Available>
