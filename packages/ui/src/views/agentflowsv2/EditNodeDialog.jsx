                    ...
                    <Box sx={{ width: '100%' }}>
                        {!isEditingNodeName ? (
                            <Stack flexDirection='row' sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                                ...
                                {data?.id && (
                                    <ButtonBase title={t('editNode.editName')} sx={{ borderRadius: '50%' }}>
                                        <Avatar
                                            variant='rounded'
                                            sx={{
                            ...
                            <Stack flexDirection='row' sx={{ width: '100%' }}>
                                ...
                                />
                                <ButtonBase title={t('editNode.saveName')} sx={{ borderRadius: '50%' }}>
                                    <Avatar
                                        variant='rounded'
                                        sx={{
                                            ...theme.typography.commonAvatar,
                                ...
                                <ButtonBase title={t('editNode.cancel')} sx={{ borderRadius: '50%' }}>
                                    <Avatar
                                        variant='rounded'
                                        sx={{
                                            ...theme.typography.commonAvatar,
